...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_calorie_1 = 18
        coeff_calorie_2 = 20
        return (coeff_calorie_1 * self.get_mean_speed() - coeff_calorie_2) * self.weight / self.M_IN_KM * self.duration * self.H_IN_MIN
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return (coeff_calorie_1 * self.weight + (self.get_mean_speed()**2 // self.height) * coeff_calorie_2 * self.weight) * self.duration * self.H_IN_MIN
